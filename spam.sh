...
clear
   echo
   echo -e "\033[31m$(figlet -f Remo773 "Prank Teman")\e[0m"
   echo
   echo -e $kuning" ╔═══════════════════════════════════════════════╗"
   echo -e $kuning" ║"   "\033[1;36mAuther    : I L H A M                      "$kuning"    ║"
   echo -e $kuning" ║"   "\033[1;36mGrub      : TEAM PROJECT                    "$kuning"    "
   echo -e $kuning" ║"   "\033[1;36mChanel YT : IlhAm ProjeCt                      "$kuning"    "
   echo -e $kuning" ║"   "\033[1;36mGithub    : https://github.com/IlhAmProject  "$kuning"    "
   echo -e $kuning" ╚═══════════════════════════════════════════════╝"

   echo -e $putih "╔════════════════════════╗"
   echo -e " ║ " "\033[1;31m  Tools Buat Prankk" $putih "  ║"
   echo -e $putih "╚════════════════════════╝"
   echo
